...
from environment import log, get_float_config_value, get_int_config_value, get_bool_config_value
...
class GPT(nn.Module):
    ...
    def __init__(self):
        ...
        log.debug("number of parameters: " + str(self.get_num_params()))
    ...
    def configure_optimizers(self, weight_decay, learning_rate, betas, device_type):
        ...
        log.debug(f"num decayed parameter tensors: {len(decay_params)}, with {num_decay_params:,} parameters")
        log.debug(f"num non-decayed parameter tensors: {len(nodecay_params)}, with {num_nodecay_params:,} parameters")
